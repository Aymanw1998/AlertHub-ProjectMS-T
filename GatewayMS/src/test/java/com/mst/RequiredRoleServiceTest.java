...
class RequiredRoleServiceTest {
    ...
    void getRequiredRole_forUserOrRoleRoutes_returnsAdmin() {
        assertEquals("admin", requiredRoleService.getRequiredRole("/api/user/1", HttpMethod.GET));
        assertEquals("admin", requiredRoleService.getRequiredRole("/api/role/get-all", HttpMethod.GET));
    }
    ...
    void getRequiredRole_forNotificationRoutes_returnsAdmin() {
        assertEquals("admin", requiredRoleService.getRequiredRole("/api/email/send", HttpMethod.POST));
        assertEquals("admin", requiredRoleService.getRequiredRole("/api/sms/send", HttpMethod.POST));
    }
